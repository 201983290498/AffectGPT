...
class OVMERD_Dataset(BaseDataset):
    def __init__(self, vis_processor=None, txt_processor=None, img_processor=None,
        ...
        ################# 直接手动指定所有信息的存储路径 #################
        ov_path = config.PATH_TO_TRANSCRIPTIONS[self.dataset]
        name2openset = {}
        ...
        description_path = os.path.join(config.DATA_DIR[self.dataset], 'track3_train_ovmerd.csv')
        name2reason = {}
